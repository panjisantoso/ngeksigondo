...
@section('tittle', 'Create Pengumuman')
      ...
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-header border-0">
                ...
                <form action="/admin/pengumuman" method="POST" class="col-md-12" enctype="multipart/form-data">

                @elseif(Auth::user()->is_admin == 2)
                <form action="/pengumuman" method="POST" class="col-md-12" enctype="multipart/form-data">
                      ...
                      @csrf
                         <input type="hidden" name="id" id="id">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-12">
                                  <textarea class="form-control" id="isi" name="isi" placeholder="Masukkan Isi Pengumuman" rows="10" cols="50" value="" required></textarea>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-12">
                                <img id="blah1" src="#" />
                                  <input type="file" onchange="readURL1(this);" class="form-control"  name="gambar1" id="gambar1" multiple accept="image/*" placeholder="Masukkan FIle Gambar 3">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-12">
                                <img id="blah2" src="#" />
                                  <input type="file" onchange="readURL2(this);" class="form-control"  name="gambar2" id="gambar2" multiple accept="image/*" placeholder="Masukkan FIle Gambar 3">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-12">
                                <img id="blah3" src="#" />
                                  <input type="file" onchange="readURL3(this);" class="form-control"  name="gambar3" id="gambar3" multiple accept="image/*" placeholder="Masukkan FIle Gambar 3">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-12">
                                  <input type="file" onchange="readURL(this);" class="form-control"  name="download" id="download" multiple accept="pdf/*" placeholder="Masukkan FIle Download">                                  
