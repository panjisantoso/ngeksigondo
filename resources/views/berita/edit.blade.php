        ...
        <div class="card">
          ...
          <div class="card-header border-0">
                ...
                @if(Auth::user()->is_admin == 1)
                    <form action="/admin/berita/{{ $berita->id }}" method="POST" class="col-md-12" enctype="multipart/form-data">
                @elseif(Auth::user()->is_admin == 2)
                    <form action="/berita/{{ $berita->id }}" method="POST" class="col-md-12" enctype="multipart/form-data">
                @endif
                      @csrf
                      @method('PUT')
                         ...
                         <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-12">
                              <textarea name="isi_berita" id="isi_berita" rows="9"  class="form-control" placeholder="Masukkan Isi Berita">{{ $berita->isi_berita }}</textarea>                                  
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-12">
                                  <input type="date" class="form-control" id="tanggal_berita" name="tanggal_berita" placeholder="Masukkan Tanggal" value="{{ $berita->tanggal_berita }}" required>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-12">
                                <img id="blah" src="/{{ $berita->gambar }}" style="width:300px; height:200px;" />
