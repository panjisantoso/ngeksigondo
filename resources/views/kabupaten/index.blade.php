            ...
            <table class="table table align-items-center table-flush" id="laravel_crud" >
              <thead class="thead-light">
                <tr>
                  ...
                  <th scope="col" class="sort" data-sort="name">Nama Kabupaten</th>
                  <th scope="col">Action</th>
                </tr>
              </thead>
              <tbody class="list">
                @for($i = 1; $i <= sizeof($kabupaten); $i++)
                  <tr id="row_{{$kabupaten[$i-1]->id}}">
                    <td>
                    {{ $i }}
                    </td>
                    <td>
                    {{ $kabupaten[$i-1]->nama_kabupaten }}
                    </td>
                    
                    <td>
                      <a href="javascript:void(0)" data-id="{{ $kabupaten[$i-1]->id }}" onclick="editKabupaten(event.target)" class="btn btn-info">Edit</a>
                      <a href="javascript:void(0)" data-id="{{ $kabupaten[$i-1]->id }}" class="btn btn-danger" onclick="deleteKabupaten(event.target)">Delete</a>
                    </td>
                  </tr>
                @endfor
              </tbody>
